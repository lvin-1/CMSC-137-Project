    ...
    public void start(Stage primaryStage) throws InterruptedException {
        try {
            ...
            case "1":
                ...
                players[0] = new Player(startX, startY, PLAYER_RADIUS, playerID, client.getSocket(), serverAddress, SERVER_PORT);
                break;
            case "2":
                startX = WINDOW_WIDTH /11;
                startY = WINDOW_HEIGHT / 2;
                players[1] = new Player(startX, startY, PLAYER_RADIUS, playerID, client.getSocket(), serverAddress, SERVER_PORT);
                break;
            case "3":
                startX = WINDOW_WIDTH - WINDOW_WIDTH / 4;
                startY = WINDOW_HEIGHT / 2;
                players[2] = new Player(startX, startY, PLAYER_RADIUS, playerID, client.getSocket(), serverAddress, SERVER_PORT);
                break;
            case "4":
                startX = WINDOW_WIDTH - WINDOW_WIDTH /11;
                startY = WINDOW_HEIGHT / 2;
                players[3] = new Player(startX, startY, PLAYER_RADIUS, playerID, client.getSocket(), serverAddress, SERVER_PORT);
                break;
            default:
