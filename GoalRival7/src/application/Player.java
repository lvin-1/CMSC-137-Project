...
class Player extends Sprite {
    ...
    public Player(double x, double y, double radius, String playerID, DatagramSocket socket, InetAddress serverAddress, int serverPort, GameStage stage) {
        ...
        // Load player image based on player ID
        String imagePath = "/images/player" + playerID + ".png";
        Image image = new Image(getClass().getResource(imagePath).toExternalForm());
        circle.setFill(new ImagePattern(image));
    }

    // Method to handle player movement based on key press
    public void move(KeyCode code) {
        ...
        // Send movement update to server if player has moved
    ...
    // Method to check for collision with other sprites
    @Override
    public void checkCollision(Sprite other) {
        if (other instanceof Ball) {
            ...
            // Check for collision and resolve if collided
    ...
    // Method to get the radius of the player
    @Override
